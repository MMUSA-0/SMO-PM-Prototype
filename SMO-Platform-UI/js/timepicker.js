...
const tPickerInput = document.querySelectorAll('.time-control');

tPickerInput.forEach(input => {
	const tpicker = new timepicker(input, args)
	...
	function timepicker(element, args) {
		...
		this.buildTimepicker = function () {
			...
			if (!Object.keys(this.elements).length) {
				...
				for (e = 0; e < elements.length; e++) {
					...
					up.className = 'timepicker__button timepicker__button--up'
					display.className = 'timepicker__display'
					down.className = 'timepicker__button timepicker__button--down'
		...
		this.render = function () {
			...
			for (e = 0; e < Object.keys(this.elements).length; e++) {
				...
				element.querySelector('.timepicker__display').innerText = this[func]()
