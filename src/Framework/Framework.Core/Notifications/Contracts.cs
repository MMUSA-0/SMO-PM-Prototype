...
namespace Framework.Core.Notifications
{
    ...
    public interface INotificationsManager
    {
        ...
        /// </param>
        Task<bool> EnqueueEmailAsync(EmailMessage message, NotificationLanguage? preferredLanguage = null);
        ...
        /// The preferred language.
        /// </param>
        Task<ApiResponse<string>> EnqueueSmsAsync(SmsMessage message, NotificationLanguage? preferredLanguage = null);
    ...
    public interface IEmailService
    {
        ...
        /// </param>
        Task<bool> SendEmail(EmailMessage emailMessage, NotificationSettings notificationSettings);
    }
    ...
    public interface ISmsService
    {
        ...
        /// The email message.
        Task<ApiResponse<string>> SendSms(SmsMessage smsMessage);
    }
