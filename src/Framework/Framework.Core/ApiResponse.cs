...
namespace Framework.Core
{
    ...
    {
        public static ApiResponse<T> MergeReturnValue<T>(this ApiResponse<T> response, T returnResult)
        {
            if (returnResult != null) response.Value = returnResult;
            else
            {
                response.Message = SharedResources.UnexpectedError;
                response.ModelStateErrors.Add(new Item(string.Empty, SharedResources.UnexpectedError));
