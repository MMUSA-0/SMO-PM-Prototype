...
namespace Framework.Core.Globalization
{
    ...
    public class GlobalizationMiddlewareHeader
    {
        /// <summary>
        /// The _next.
        /// </summary>
        ...
        /// The next.
        /// </param>
        public GlobalizationMiddlewareHeader(RequestDelegate next)
        {
            this.next = next;
        }
        ...
        {
            // Do something with context near the beginning of request processing.
            CultureHelper.InitializeCultureFromHeadersAr(context);
            await this.next.Invoke(context);
    ...
    public static class GlobalizationMiddlewareExtensions
    {
        ...
        /// </returns>
        public static IApplicationBuilder UseGlobalization(this IApplicationBuilder builder, string defaultCulture = null, bool isFromHeaders = true)
        {
            if (defaultCulture == null && !isFromHeaders) return builder.UseMiddleware<GlobalizationMiddlewareAr>();
            else if (isFromHeaders) return builder.UseMiddleware<GlobalizationMiddlewareHeader>();
