...
namespace Framework.Core.Data
{
    ...
    public static class Extensions
    {
        ...
        public static PagedList<T> GetListPaged<T>(this List<T> query, int pageNum, int pageSize)
        {
            return new PagedList<T>(query, pageNum, pageSize);
        }

        public static void UpdateEntity<T>(this T existingEntity, T updatedEntity) where T : EntityBase
        {
